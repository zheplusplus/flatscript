...
NodeType const test::COND_CALLBACK_PARAM("conditional callback parameter");
NodeType const test::REFERENCE("reference");
NodeType const test::SUB_REFERENCE("sub reference");
NodeType const test::TRANSIENT_PARAMETER("transient parameter");
...
NodeType const test::MANGLE_AS_PARAM("mangle args as param");
