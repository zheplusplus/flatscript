#ifndef __STEKIN_UTILITY_TYPE_TRAITS_HPP__
#define __STEKIN_UTILITY_TYPE_TRAITS_HPP__
...
namespace tp {
    ...
    typedef tp::Int<4>::type sh_int;
    typedef tp::UInt<4>::type sh_uint;

}

#endif /* __STEKIN_UTILITY_TYPE_TRAITS_HPP__ */
