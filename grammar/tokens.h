...
namespace grammar {
    ...
    enum TokenType {
        IF, ELSE, IFNOT, PIPE_SEP, COMMA, COLON, PROP_SEP, OPEN_PAREN, OPEN_BRACKET, OPEN_BRACE,
        CLOSE_PAREN, CLOSE_BRACKET, CLOSE_BRACE, THIS, OPERATOR, FUNC, TRY, CATCH, THROW, CLASS,
        SUPER, CONSTRUCTOR, TOKEN_TYPE_COUNT
    };
