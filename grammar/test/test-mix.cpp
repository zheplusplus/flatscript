    ...
    DataTree::expectOne()
        (BLOCK_BEGIN)
            ...
            (misc::position(35), ARITHMETICS)
                (misc::position(35), LIST_PIPELINE_BEGIN)
                    ...
                    (misc::position(35), PIPE_MAP)
                        ...
                        (misc::position(35), OPERAND)
                            (misc::position(35), LIST_ELEMENT)
                (misc::position(35), LIST_PIPELINE_END)
            ...
            (misc::position(50), NAME_DEF, "x")
                (misc::position(50), DICT_BEGIN)
                (misc::position(50), DICT_ITEM)
                    (misc::position(47), INTEGER, "1")
                    (misc::position(47), INTEGER, "2")
                (misc::position(50), DICT_ITEM)
                    (misc::position(48), INTEGER, "3")
                    (misc::position(48), INTEGER, "4")
                (misc::position(50), DICT_ITEM)
                    (misc::position(49), INTEGER, "5")
